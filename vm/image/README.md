...
The guest provides a stock Weston desktop at 1280×720 and scale 1, Chromium with CDP on guest port 9222, SSH, deterministic locale/fonts, common development runtimes, XFCE Terminal, Galculator, and a `candidate` virtiofs mount at `/workspace`.
